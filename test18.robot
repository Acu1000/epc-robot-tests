*** Settings ***
Documentation     Verification that the system blocks data transfer with invalid protocol value.
...
Scenario 21: Attempt to start data transfer with invalid protocol
    ...
    When User Attempts To Start Data Transfer With Invalid Protocol For UE ${UE_ID}
...
User Attempts To Start Data Transfer With Invalid Protocol For UE ${id}
    ${body}=    Create Dictionary    protocol=${INVALID_PROTOCOL}    Mbps=10
